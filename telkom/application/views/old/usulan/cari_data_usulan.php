...
<form name="form" method="post" action="<?php echo base_url();?>index.php/usulan/cari_detail">
...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <td align="center" width="100" ><?php echo $db['idusulan'];?></td>
            <td><?php echo $db['detail']; ?></td>
			<td><?php echo $db['satuan'];?></td>
			<td><?php echo $db['jenis'];?></td>
            <td align="center" width="80">
            <a href="#" onclick="window.opener.document.getElementById('idusulan').value = '<?php echo $db['idusulan'];?>'; window.opener.document.getElementById('detail').value = '<?php echo $db['detail'];?>';
