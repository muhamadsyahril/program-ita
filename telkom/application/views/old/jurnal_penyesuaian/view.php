...
<a href="<?php echo base_url();?>index.php/jurnal_penyesuaian">
<button type="button" name="refresh" id="refresh" class="easyui-linkbutton" data-options="iconCls:'icon-reload'">Refresh</button>
</a>
</div>
<div style="float:right; padding-bottom:5px;">
<form name="form" method="post" action="<?php echo base_url();?>index.php/jurnal_penyesuaian">
...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <a href="<?php echo base_url();?>index.php/jurnal_penyesuaian/hapus/<?php echo $db['no_jurnal'];?>"
...
<tr>
    ...
    <td align="center"><input type="text" name="dr" id="dr" class="angka" size="20" maxlength="20" /></td>
    <td align="center"><input type="text" name="kr" id="kr" class="angka" size="20" maxlength="20" /></td>
</tr>    
</table>
</fieldset>
